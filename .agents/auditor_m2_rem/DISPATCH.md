...
## Working Directory
`c:\Users\User\OneDrive\Desktop\New folder (2)\.agents\auditor_m2_rem`
...
`c:\Users\User\OneDrive\Desktop\New folder (2)\.agents\auditor_m2_rem\handoff.md`
...
Read `c:\Users\User\OneDrive\Desktop\New folder (2)\ORIGINAL_REQUEST.md` (authoritative user request), `c:\Users\User\OneDrive\Desktop\New folder (2)\.agents\auditor_m2_rem\DISPATCH.md`, and `c:\Users\User\OneDrive\Desktop\New folder (2)\.agents\worker_m2\handoff.md` first.
...
Write your report to `c:\Users\User\OneDrive\Desktop\New folder (2)\.agents\auditor_m2_rem\handoff.md` with explicit verdict CLEAN or INTEGRITY VIOLATION. Send a completion message with your verdict when finished. Maintain progress.md with timestamps.
